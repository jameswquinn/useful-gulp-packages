...
const core = ['node_modules/webfontloader/src/webfontloader.js'
...
const vendor = ['node_modules/covervid/covervid.js',
...
gulp.task('build:babel', ['build:scripts:core', 'build:scripts:vendor', 'build:scripts:app']() => );